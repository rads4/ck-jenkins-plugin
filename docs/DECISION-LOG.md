# ck-aws — decision log (historical record)

Moved out of `CLAUDE.md` on 2026-08-24 to cut per-turn context cost. Nothing was
edited or removed — these are the original sections verbatim. CLAUDE.md now carries
the operationally live material and points here for rationale.

Contents: v2.0 (2026-08-07) · M12 Universal Attribution · M11 Managed Authentication ·
Rejected designs · Migration strategy · Definition of Done (M6, M11).
